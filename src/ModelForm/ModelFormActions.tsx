    ...
    data && (
      <div className={twMerge('flex justify-center', className)}>
        <Lens lens={!isLoading && DataLens.VALUE}>
          <button
            type="button"
            className="flex h-full items-center justify-center rounded-l-sm border-[--primary] text-[--primary] focus:bg-[--primary] hover:bg-[--primary] focus:text-[--text-color] hover:text-[--text-color]"
            onClick={onEdit}
          ...
          {!onCreate && onDelete && (
            <button
              ...
              type="button"
              className="flex h-full items-center justify-center rounded-r-sm border-[--danger] text-[--danger] focus:bg-[--danger] hover:bg-[--danger] focus:text-[--text-color] hover:text-[--text-color]"
            >
              Delete
            </button>
          )}
        ...
        <Lens lens={!isLoading && DataLens.INPUT}>
          {onUpdate && (
            <button
              className="flex h-full items-center justify-center rounded-l-sm border-[--success] text-[--success] focus:bg-[--success] hover:bg-[--success] focus:text-[--text-color] hover:text-[--text-color]"
              type="submit"
            >
          ...
          <button
            type="button"
            className="flex h-full items-center justify-center rounded-r-sm border-[--primary] text-[--primary] focus:bg-[--primary] hover:bg-[--primary] focus:text-[--text-color] hover:text-[--text-color]"
