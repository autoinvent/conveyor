...
import { BaseComponentProps, ModelField } from '../../aaconveyor/types';
...
import { LIST_QUERY } from '../constants';
import { ConveyorContext } from '../contexts/ConveyorContext';
import { generateOperationName, generateGQLQueryDocument } from '../utils'
...
const ModelIndex = ({
    ...
    return (
        <Container id={id} className={className}>
            {data?.[operation] &&
                <ModelTableProvider title={'hello'} data={data[operation].items} fields={fields}>
                    {children || (
                        <>
                            <ModelTable />
                        </>
