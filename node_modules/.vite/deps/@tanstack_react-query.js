...
// node_modules/.pnpm/@tanstack+react-query@4.0.10_react-dom@18.2.0+react@18.2.0/node_modules/@tanstack/react-query/build/esm/index.js
...
function useQueries({
  ...
  (0, import_shim.useSyncExternalStore)(React.useCallback((onStoreChange) => isRestoring ? () => void 0 : observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer, isRestoring]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  React.useEffect(() => {
...
var QueryErrorResetBoundary = ({
  ...
  return React.createElement(QueryErrorResetBoundaryContext.Provider, {
    value
...
function useIsFetching(arg1, arg2, arg3) {
  ...
  return (0, import_shim.useSyncExternalStore)(React.useCallback((onStoreChange) => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isFetching(filters), () => queryClient.isFetching(filters));
}
function useIsMutating(arg1, arg2, arg3) {
  ...
  return (0, import_shim.useSyncExternalStore)(React.useCallback((onStoreChange) => mutationCache.subscribe(notifyManager.batchCalls(onStoreChange)), [mutationCache]), () => queryClient.isMutating(filters), () => queryClient.isMutating(filters));
}
function useMutation(arg1, arg2, arg3) {
  ...
  const result = (0, import_shim.useSyncExternalStore)(React.useCallback((onStoreChange) => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
