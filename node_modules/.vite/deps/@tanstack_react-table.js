...
// node_modules/.pnpm/@tanstack+react-table@8.5.5_react-dom@18.2.0+react@18.2.0/node_modules/@tanstack/react-table/build/esm/index.js
...
function getExpandedRowModel() {
  return (table) => memo(() => [table.getState().expanded, table.getPreExpandedRowModel(), table.options.paginateExpandedRows], (expanded, rowModel, paginateExpandedRows) => {
    if (!rowModel.rows.length || !paginateExpandedRows || expanded !== true && !Object.keys(expanded != null ? expanded : {}).length) {
      return rowModel;
    }
